...
public class ComponentManager {
    ...
    private static final String APPINVENTOR_BASE = "com.google.appinventor.components.runtime.";
    private static final String INBUILT_BASE = "xyz.kumaraswamy.tasks.inbuilt.";
    ...
    public static String getSourceString(final Object component) {
        if (component instanceof Component) {
            ...
            if (!fullName.contains(".") && Character.isLetter(fullName.charAt(0))) {
                fullName = APPINVENTOR_BASE + fullName;
                isSimpleName = true;
    ...
    private void createFromSource(String source, final String key, final boolean isLastKey) {
        Class<?> baseClass;
        final Constructor<?> baseConstructor;
        try {
            if (source.startsWith("#"))
                source = INBUILT_BASE + source.substring(1);
    ...
    public class FForm extends Form {
        ...
        public EventRaisedListener getListener() {
            return eventRaisedListener;
        }
